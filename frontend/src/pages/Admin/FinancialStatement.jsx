...
const FinancialStatements = () => {
  ...
  const exportToExcel = () => {
    const sheetData = paymentRecords.map(record => ({
      ...
      XrayPayment: record.xrayPayment,
        ...
        <table className="min-w-full bg-white border border-gray-200 rounded-lg">
          <thead>
            <tr>
              ...
              <th className="py-2 px-4 border-b border-gray-200 text-left text-gray-600 font-semibold">Mode of Payment</th> {/* Moved field */}
              <th className="py-2 px-4 border-b border-gray-200 text-left text-gray-600 font-semibold">REF NO.</th>
              <th className="py-2 px-4 border-b border-gray-200 text-left text-gray-600 font-semibold">Amount Paid</th> {/* Moved field */}
              <th className="py-2 px-4 border-b border-gray-200 text-left text-gray-600 font-semibold">Commission</th> {/* Moved field */}
              <th className="py-2 px-4 border-b border-gray-200 text-left text-gray-600 font-semibold">Xray Payment</th> {/* Moved field */}
              <th className="py-2 px-4 border-b border-gray-200 text-left text-gray-600 font-semibold">Amount Due</th> {/* Moved field */}
          ...
          <tbody>
            {paymentRecords.map((record, index) => (
              <tr key={index} className="hover:bg-gray-50 transition duration-200">
                ...
                <td className="py-2 px-4 border-b border-gray-200">{record.modeOfPayment}</td> {/* Moved field */}
                <td className="py-2 px-4 border-b border-gray-200">{record.accountNumber}</td>
                <td className="py-2 px-4 border-b border-gray-200 text-right">sh {record.amountPaid}</td> {/* Moved field */}
                <td className="py-2 px-4 border-b border-gray-200">{record.commission}</td> {/* Moved field */}
                <td className="py-2 px-4 border-b border-gray-200">{record.xrayPayment}</td> {/* Moved field */}
                <td className="py-2 px-4 border-b border-gray-200 text-right">sh {record.amountDue}</td> {/* Moved field */}
