...
import { FaChevronCircleLeft, FaChevronCircleRight, FaSearch, FaTimes, FaXRay, FaLungs } from "react-icons/fa";
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="border-b border-teal-700 pb-4">
                    <h2 className="text-2xl font-bold flex items-center gap-3">
                        <FaXRay className="text-teal-300" />
                        Radiology Queue
                    </h2>
                    <p className="text-teal-200 text-sm mt-2">
                        {filteredReports.length} patient{filteredReports.length !== 1 ? 's' : ''} ready for imaging
                    </p>
                </div>
                ...
                {isLoading ? (
                    <div className="text-center py-12">
                        ...
                        <p className="text-sm text-teal-200 mt-2">Fetching patients ready for radiology imaging</p>
                    </div>
                        ...
                        <div className="bg-teal-800 border border-teal-600 rounded-lg p-4">
                            <div className="flex items-start gap-3">
                                <div className="w-8 h-8 bg-teal-600 rounded-full flex items-center justify-center flex-shrink-0">
                                    <FaLungs className="text-white text-sm" />
                                </div>
                                <div>
                                    <p className="text-sm text-white font-medium">
                                        F-Series Patients ({filteredReports.length})
                                    </p>
                                    <p className="text-xs text-teal-200 mt-1">
                                        S-series patients excluded from radiology imaging
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-teal-200 text-sm">No patients waiting for radiology imaging.</p>
                        <p className="text-teal-300 text-xs mt-2">All F-series reports have been processed.</p>
                    </div>
                )}
