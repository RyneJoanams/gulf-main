    ...
    <div className="max-w-7xl mx-auto bg-gray-50 p-8 shadow-lg rounded-lg">
      ...
      {patientData ? (
        <>
          ...
          <div className="mb-4">
            <label className="block text-gray-600 font-semibold mb-2" htmlFor="modeOfPayment">Mode of Payment</label>
            <select
              id="modeOfPayment"
              className="w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-150 ease-in-out"
              value={modeOfPayment}
          ...
          <div className="mb-4">
            <label className="block text-gray-600 font-semibold mb-2" htmlFor="accountNumber">REF NO.</label>
            <input
              type="text"
              id="accountNumber"
              className="w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-150 ease-in-out"
          ...
          <div className="mb-4">
            <label className="block text-gray-600 font-semibold mb-2" htmlFor="commission">Commission</label>
            <input
              type="number"
              id="commission"
              className="w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-150 ease-in-out"
          ...
          <div className="mb-4">
            <label className="block text-gray-600 font-semibold mb-2" htmlFor="xrayPayment">Xray Payment</label>
            <input
              type="number"
              id="xrayPayment"
              className="w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-150 ease-in-out"
                    ...
                    <tbody>
                      {paymentRecords.map((record) => (
                        <tr key={record._id}>
                          ...
                          <td className="border">{record.modeOfPayment}</td>
                          <td className="border">{record.accountNumber}</td>
                          <td className="border">{record.amountPaid}</td>
                          <td className="border">{record.commission}</td>
                          <td className="border">{record.xrayPayment}</td>
